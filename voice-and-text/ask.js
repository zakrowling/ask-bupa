...
recognition.onresult = (event) => {
    ...
    outputDiv.innerHTML = "<i id='clearSearch' class='fa fa-times' aria-hidden='true' onclick='parentNode.remove()'></i><a href='https://www.bupa.com.au' target='_blank'>" + transcript + "</a>";
