...
recognition.onresult = (event) => {
    ...
    outputDiv.innerHTML = "<i class='fa fa-times remove-search' aria-hidden='true' onclick='parentNode.remove()'></i><a href='https://www.bupa.com.au' target='_blank'>" + transcript + "</a>";
