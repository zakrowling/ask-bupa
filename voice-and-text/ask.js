...
recognition.onresult = (event) => {
    ...
    outputDiv.innerHTML = "<span id='searchTag'><i onclick='hideSearch()' id='clearSearch' title='Clear Search' class='fa-solid fa-circle-xmark' aria-hidden='true'></i><a href='" + searchURL + "' target='_blank'>" + transcript + "</a></span>";
